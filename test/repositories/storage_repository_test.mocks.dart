...
// in magic_record/test/repositories/storage_repository_test.dart.
...
///
/// See the documentation for Mockito's code generation for more information.
class MockHiveBoxOfList extends _i1.Mock implements _i2.Box<List<dynamic>> {
  @override
  Iterable<List<dynamic>> get values => (super.noSuchMethod(
        Invocation.getter(#values),
        returnValue: <List<dynamic>>[],
        returnValueForMissingStub: <List<dynamic>>[],
      ) as Iterable<List<dynamic>>);
  @override
  ...
  @override
  Iterable<List<dynamic>> valuesBetween({
    dynamic startKey,
    dynamic endKey,
  }) =>
      (super.noSuchMethod(
  ...
  @override
  List<dynamic>? getAt(int? index) => (super.noSuchMethod(
        Invocation.method(
          #getAt,
          [index],
        ),
  ...
  @override
  Map<dynamic, List<dynamic>> toMap() => (super.noSuchMethod(
        Invocation.method(
          #toMap,
          [],
        ),
        returnValue: <dynamic, List<dynamic>>{},
        returnValueForMissingStub: <dynamic, List<dynamic>>{},
      ) as Map<dynamic, List<dynamic>>);
  @override
  ...
  @override
  _i3.Future<void> putAll(Map<dynamic, List<dynamic>>? entries) =>
      (super.noSuchMethod(
        Invocation.method(
          #putAll,
          [entries],
  ...
  @override
  _i3.Future<int> add(List<dynamic>? value) => (super.noSuchMethod(
        Invocation.method(
          #add,
          [value],
        ),
  ...
  @override
  _i3.Future<Iterable<int>> addAll(Iterable<List<dynamic>>? values) =>
      (super.noSuchMethod(
        Invocation.method(
          #addAll,
          [values],
